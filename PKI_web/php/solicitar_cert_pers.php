      ...
      <div class="starter-template">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" placeholder="Introduce tu apellido" id="apellido" required>
          </div>
        </div>
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              <label for="provincia">Estado o Provincia</label>
              <input class="form-control" type="text" id="provincia" placeholder="Estado o provincia" required>
            </div>
            <div class="form-group col-md-4">
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input class="form-control" type="text" id="company" placeholder="Compañia" required>
          </div>
          <div class="form-group col-md-6">
            <label for="email">Email</label>
            <input type="email" id="email" class="form-control" placeholder="alguien@email.com" required>
          </div>
        </div>
